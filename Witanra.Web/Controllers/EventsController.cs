...
namespace Witanra.Web.Controllers
{
    public class EventsController : Controller
    {
        ...
        public EventsController(WitanraDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EventId,Start,End,Value")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,Start,End,Value")] Event @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
